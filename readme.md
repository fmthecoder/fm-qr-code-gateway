...
**Contributors:** [fmthecoder](https://github.com/fmthecoder)  
...
Accept UPI payments via QR code in WooCommerce. Customers enter a Transaction ID at checkout. Lightweight & easy to configure.
...
Customers scan the QR code, make the payment, and enter their **Transaction ID** — which is securely saved in the order details.

> **Note:**  
> This plugin is an independent open-source project created and maintained by the developer.  
...
1. Upload the plugin folder to `/wp-content/plugins/fm-qr-code-gateway/`,  
...
[GNU General Public License](https://www.gnu.org/licenses/gpl-2.0.html) as published by the Free Software Foundation,  
...
### 🧑‍💻 Author
**Developed by [fmthecoder](https://github.com/fmthecoder)**  
If you like this plugin, ⭐ star the repo and share your feedback!
